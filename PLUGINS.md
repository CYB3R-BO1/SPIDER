# SPIDER - Plugin Development Guide

## Overview

SPIDER supports **dynamically loaded analysis plugins**. Plugins are Python files that expose an `analyze()` function. They are automatically discovered and loaded from the `plugins/` directory.
